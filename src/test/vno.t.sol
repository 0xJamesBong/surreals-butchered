...
contract VNOTest is Test {
    ...
    function testMakeZero() public {
        ...
        string memory aliceNestedString = vno
            .getUniversalFromTokenId(tokenId_before_mint)
            .nestedString;
        uint256 aliceNumber = vno
            .getUniversalFromTokenId(tokenId_before_mint)
            .number;
        uint256 aliceInstances = vno
            .getUniversalFromTokenId(tokenId_before_mint)
            .instances;
        (, uint256 aliceMintTime, uint256 aliceOrder) = vno.tokenId_to_metadata(
            tokenId_before_mint
        );
        ...
        console.log(
            ...
            tokenId_before_mint,
            "is",
            vno.ownerOf(tokenId_before_mint)
        );
        ...
        string memory bobNestedString = vno
    ...
    function testMintViaAddition() public {
        ...
        uint256 oneTokenId = vno.mintSuccessor(alice, zeroTokenId);
        uint256 twoTokenId = vno.mintSuccessor(alice, oneTokenId);
        uint256 threeTokenId = vno.mintByAddition(
            alice,
            oneTokenId,
            twoTokenId
        ); // minting by addition
        ...
        assertEq(
            vno.getNumberFromTokenId(threeTokenId),
    ...
    function testMakePolygon() public {
        string memory polygon = vno.makePolygon(7);
        console.log(polygon);
    }
