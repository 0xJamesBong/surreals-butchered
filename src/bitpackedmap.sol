...
contract BitPackedMap {
    ...
    //         pixelRow[4] = string(abi.encodePacked('<rect fill="', _getFillFromSquare(_getSquareFromMap(bitmap, i + 3)), '" x="4" y="', _toString(y), '" width="1" height="1" />'));
    //         pixelRow[5] = string(abi.encodePacked('<rect fill="', _getFillFromSquare(_getSquareFromMap(bitmap, i + 3)), '" x="5" y="', _toString(y), '" width="1" height="1" />'));
    //         pixelRow[6] = string(abi.encodePacked('<rect fill="', _getFillFromSquare(_getSquareFromMap(bitmap, i + 2)), '" x="6" y="', _toString(y), '" width="1" height="1" />'));
    //         pixelRow[7] = string(abi.encodePacked('<rect fill="', _getFillFromSquare(_getSquareFromMap(bitmap, i + 1)), '" x="7" y="', _toString(y), '" width="1" height="1" />'));
    //         pixelRow[8] = string(abi.encodePacked('<rect fill="', _getFillFromSquare(_getSquareFromMap(bitmap, i)), '" x="8" y="', _toString(y), '" width="1" height="1" />'));
    ...
    //         svgString = string(abi.encodePacked(svgString, pixelRow[0], pixelRow[1], pixelRow[2], pixelRow[3], pixelRow[4], pixelRow[5], pixelRow[6], pixelRow[7], pixelRow[8]));
